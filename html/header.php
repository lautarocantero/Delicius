    ...
    <div class="header">
        ...
        <nav class="navegacion">
            <ul class="header-navegacion">
                ...
                <li><a href="clientes" class="link">En familia</a></li>
                <li><a href="#" class="link">Nosotros</a></li>
                <li><a href="#" class="link">Mi menu</a></li>
                <li><a href="nuevo-cliente" class="link">Cuenta <i class="fas fa-user icono"></i> </a></li>
            </ul>
        </nav>
    </div>